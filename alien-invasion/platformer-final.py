...
# Images
idle = load_image('assets/images/Player/p1_stand.png')
walk = [load_image('assets/images/Player/p1_walk/PNG/p1_walk06.png'),
        load_image('assets/images/Player/p1_walk/PNG/p1_walk05.png'),
        load_image('assets/images/Player/p1_walk/PNG/p1_walk04.png') ]
jump = load_image('assets/images/Player/p1_jump.png')
hurt = load_image('assets/images/Player/p1_hurt.png')
...
tile_images = { "Grass": load_image('assets/images/tiles/grassMid.png'),
...
fast_enemy_images = { "fastwalk_rt": fastwalk,
                      "fastwalk_lt": [flip_image(img) for img in fastwalk] }

item_images = { "Gem": load_image('assets/images/items/coinGold.png'),
                "Heart": load_image('assets/images/items/heart_1.png'),
                "Slow": load_image('assets/images/items/slow_1.png') }

# Levels
levels = ["assets/levels/level_1.json",
          "assets/levels/level_1_s2.json",
          "assets/levels/level_1_s3.json",
          "assets/levels/level_2.json",
          "assets/levels/level_2_s2.json",]
...
class BasicEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, images):
        ...
        self.images = images
        self.image = self.images["fastwalk_rt"][0]
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
    ...
    def set_image(self):
        if self.vx > 0:
            ...
            self.image = self.images["fastwalk_lt"][0]
...
class Level():
    ...
    def load_enemies(self):
        ...
        for element in self.map_data['enemies']:
            ...
            if kind == "BasicEnemy":
                s = BasicEnemy(x, y, fast_enemy_images)
            elif kind == "PlatformEnemy":
                s = PlatformEnemy(x, y, platform_enemy_images)
            elif kind == "FastEnemy":
                s = FastEnemy(x, y, fast_enemy_images)
